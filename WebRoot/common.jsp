...
<link rel="stylesheet" href="<%=request.getContextPath() %>/tablesort/css/theme.blue.min.css">		
...
<script type="text/javascript" src="<%=request.getContextPath() %>/userjs/common.js"></script>
